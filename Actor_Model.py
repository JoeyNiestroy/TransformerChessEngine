...
if __name__ == '__main__':
    ...
    optimizer =  optim.AdamW(model.parameters(), lr = 1e-4,betas=(0.9, 0.999), weight_decay= 1e-2)    #optim.SGD(model.parameters(), lr = 1e-3, momentum=.9)#optim.Adam(model.parameters(), lr = 5e-4,betas=(0.9, 0.999))  # Feel free to use any optimizer
